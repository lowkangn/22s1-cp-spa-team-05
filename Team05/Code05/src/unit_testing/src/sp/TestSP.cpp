...
TEST_CASE("Test Source Processor : extractPattern") {
	...
	SECTION("Test milestone 1 program #2") {
		...
		vector<Pattern> expected{
			...
			Pattern::createAssignPattern(6,"x", "x102*+"),
			Pattern::createAssignPattern(7,"y", "y10-"),
			Pattern::createAssignPattern(8,"b", "a"),
			Pattern::createAssignPattern(9,"y", "x2%y+"),
			Pattern::createAssignPattern(10,"z", "5x*y-"),
			Pattern::createAssignPattern(11,"z", "z1/3*"),
			Pattern::createAssignPattern(13,"x", "x1+1-"),
		};
