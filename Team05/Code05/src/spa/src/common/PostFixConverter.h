...
private:
    ...
    */
    // refer to https://www.tutorialspoint.com/Convert-Infix-to-Postfix-Expression#:~:text=To%20convert%20infix%20expression%20to,maintaining%20the%20precedence%20of%20them. //NOLINT(whitespace/line_length)
    ...
    string convertInfixToPostFix(string infixString) {
        ...
        for (string token : splitStrings) {
            if (this->isAlphanumeric(token)) {
                ...
                // get all the operands inside the brackets
