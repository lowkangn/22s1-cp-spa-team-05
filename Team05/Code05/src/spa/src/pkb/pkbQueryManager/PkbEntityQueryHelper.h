...
public:
    ...
    */
    vector<shared_ptr<PkbEntity>> retrieveAllProcedureEntities(
        shared_ptr<PkbRepository> repository);

    /*
        Retrieves all statement entities, regardless of type.
    */
    vector<shared_ptr<PkbEntity>> retrieveAllStatementEntities(
        shared_ptr<PkbRepository> repository);
    ...
    */
    ...
    /*
        ...
        from the repository.
    */
    shared_ptr<PkbEntity> retrieveEntityByTypeAndKey(
        string key, PkbEntityType type, shared_ptr<PkbRepository> repository);

    /*
        Creates a filter from tracked statement types.
    */
    PkbStatementEntityFilter getFilterToCheckForStatementType(
        PkbStatementType statementType, bool defaultTrue = false) {
