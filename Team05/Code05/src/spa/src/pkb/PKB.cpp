#include <common/StringSplitter.h>
...
// -------------------- by type --------------------
vector<PQLEntity> PKB::retrieveStatementEntitiesByType(
    PKBTrackedStatementType pkbTrackedStatementType) {
    return this->queryManager.retrieveStatementEntitiesByType(
...
optional<PQLEntity> PKB::retrieveStatementByLineNumberAndType(int lineNumber,
    PKBTrackedStatementType pkbTrackedStatementType) {
    return this->queryManager.retrieveStatementByLineNumberAndType(
        lineNumber,
        pkbTrackedStatementType,
        this->repository);
}
...
// -------------------- specifics --------------------
vector<PQLRelationship> PKB::retrieveRelationshipByTypeAndLhsRhs(
    PKBTrackedRelationshipType relationshipType, ClauseArgument lhs, ClauseArgument rhs) {
    return this->queryManager.retrieveRelationshipByTypeAndLhsRhs(
        relationshipType,
        lhs,
        rhs,
        this->repository,
...
vector<PQLPattern> PKB::retrievePatterns(PKBTrackedStatementType statementType,
    ClauseArgument lhs, ClauseArgument rhs) {
