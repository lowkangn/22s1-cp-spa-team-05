...
void AttributeClauseParser::checkSynonymAttributeCompatible(
    ...
    bool acceptsVarName = synonym.isVariableSynonym() || synonym.isPrintSynonym() || synonym.
        isReadSynonym();
    ...
    bool isSemanticallyCorrect = (acceptsProcName && attribute.isProcNameAttribute()) || (
        acceptsVarName && attribute.isVarNameAttribute()) || (acceptsValue && attribute.
        isValueAttribute()) || (acceptsStmtNum && attribute.isStmtNumAttribute());
