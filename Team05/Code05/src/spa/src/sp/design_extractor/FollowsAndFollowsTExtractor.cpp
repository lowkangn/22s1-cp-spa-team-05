...
vector<Relationship> FollowsAndFollowsTExtractor::extract(shared_ptr<ASTNode> ast) {
    ...
    if (ast->isIfNode()) {
        ...
        extractedRelationships.insert(
            ...
            extractedFromThen.begin(),
            extractedFromThen.end());
        extractedRelationships.insert(
            extractedRelationships.end(),
            extractedFromElse.begin(),
            extractedFromElse.end());
        ...
        extractedRelationships.insert(
            extractedRelationships.end(),
            extractedFromWhile.begin(),
            extractedFromWhile.end());
        ...
        extractedRelationships.insert(
            extractedRelationships.end(),
            followsRelationships.begin(),
            followsRelationships.end());
    } else {
