...
for i in oneGroup
do
	${path_to_autotester} ${iteration2}${multi_constr_path}${i}_source.txt ${iteration2}${multi_constr_path}${i}_queries.txt ${iteration2_output_folder}${i}multipleConstraint${i}Out.xml
done
